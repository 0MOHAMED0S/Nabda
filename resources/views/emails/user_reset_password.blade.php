    ...
    <table width="100%" max-width="600" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0,0,0,0.05); overflow: hidden; border: 1px solid #e5e7eb;" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td style="padding: 40px 30px;">
                <p style="font-size: 16px; font-weight: bold; color: #1f2937;">مرحباً بك، {{ $userName }}</p>
                <p style="font-size: 15px; color: #4b5563; line-height: 1.6;">لقد تلقينا طلباً لاستعادة كلمة المرور الخاصة بحسابك على منصة نبضة خير. يرجى استخدام الرمز المكون من 6 أرقام لإتمام العملية:</p>
